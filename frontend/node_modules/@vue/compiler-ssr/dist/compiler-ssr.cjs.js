...
const SSRErrorMessages = {
    [57 /* X_SSR_CUSTOM_DIRECTIVE_NO_TRANSFORM */]: `Custom directive is missing corresponding SSR transform and will be ignored.`,
...
function ssrProcessTeleport(node, context) {
    ...
    if (!targetProp) {
        context.onError(createSSRCompilerError(59 /* X_SSR_NO_TELEPORT_TARGET */, node.loc));
        return;
    }
    let target;
    ...
    if (!target) {
        context.onError(createSSRCompilerError(59 /* X_SSR_NO_TELEPORT_TARGET */, targetProp.loc));
        return;
    }
